...
def add_student():
    if request.method == 'POST':
        ...
        cur = conn.cursor(cursor_factory=psycopg2.extras.DictCursor)
        cur.execute("INSERT INTO students (first_name, mid_name, last_name, year_level, sect_name) VALUES (%s, %s, %s, %s, %s)",(first_name, mid_name, last_name, year_level, sect_name))
        conn.commit()
